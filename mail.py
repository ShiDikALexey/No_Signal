...
def send_verification_email(to_email, verify_url, nickname):
    ...
    subject = 'No_Signal — Подтверждение регистрации'
    ...
    <body>
        <div class="container">
            ...
            <p>Спасибо за регистрацию в No_Signal. Для завершения регистрации подтвердите ваш email.</p>
            
            <a href="{verify_url}" class="button">Подтвердить email</a>
            
            <div class="info">
                ✅ После подтверждения вы получите доступ ко всем функциям No_Signal: чаты, файлы, голосовые сообщения.
            </div>
            
            <div class="warning">
                ⚠️ Ссылка действительна в течение <strong>24 часов</strong>. Если вы не регистрировались в No_Signal, просто проигнорируйте это письмо.
            </div>
