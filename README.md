...
> **v0.4.2** — UX-полировка, багфиксы архива и профиля.
...
### v0.4.2 (текущий)
- ✅ **UX**: Меню профиля — закрытие по клику снаружи, позиционирование относительно сайдбара
- ✅ **UX**: Динамический статус «В сети» / «Не в сети» в шапке чата (real-time WebSocket)
- ✅ **UX**: Локальное время сообщений — конвертация в часовой пояс клиента (formatLocalTime)
- ✅ **UX**: Индикаторы непрочитанных — бейдж-счётчик, жирный текст, сброс при открытии
- ✅ **Fix**: Архив — исправлено исчезновение списка чатов, панель скрыта когда пусто
- ✅ **Fix**: Выпадающее меню профиля привязано к сайдбару, а не к краю экрана
...
- ✅ Фикс viewport resize — визуальный viewport отслеживает клавиатуру, скролл блокируется при открытии
- ✅ scroll-behavior: auto при клавиатуре — мгновенная прокрутка без анимации
- ✅ Cache-busting `?v=4` на все статические ресурсы
- ✅ 42 автотеста — покрытие REST API, файлов, WebSocket, админки, криптографии
